...
const CarIcon: React.FC<CarIconProps> = ({ color = "#000000", distance = 0, duration = 0 }) => {
  return (
    <Box sx={{ position: "absolute", left: "70px", bottom: "-40px", transform: `translateX(${distance}px)`, transition: `transform ${duration}s linear` }}>
